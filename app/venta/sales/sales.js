...
,	function()
	{
		...
		,	{
				...
				{
					user:				undefined
				,	view:				'views/ventas/sales/init.mustache'
				,	view_amount:		'views/ventas/sales/amount.mustache'
				,	view_table:			'views/ventas/sales/table.mustache'
				,	view_remove:		'views/ventas/sales/remove.mustache'
		...
		,	{
			//	Inicializo el controlador
				init: function(element,options)
				{
					...
					//	Inserto el wizard de facturar
					this.wizardControl
					=	new	Aleph.Ventas_Invoice(
							can.$('<div>')
								.appendTo(
									this.element
								)
			...
			//	Escucho el reset
			,	'aleph.ventas.sales.reset': function(el,ev)
				{
					//	Reseto el current item
					this.currentItem
					=	undefined
					//	Reseteo viewData
					this
